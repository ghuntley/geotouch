...
namespace TwinTechs.Gestures
{
    ...
    public class BaseGestureRecognizer : BindableObject, IGestureRecognizer
    {
        ...
        public bool IsConsumingTouchesInParallel
        {
            get; set;
        }
        ...
        {
            get { return NativeGestureRecognizer == null ? 0 : NativeGestureRecognizer.NumberOfTouches; }
        }

        public GestureRecognizerState State
        {
            get { return NativeGestureRecognizer == null ? GestureRecognizerState.Failed : NativeGestureRecognizer.State; }
        }
        ...
        internal INativeGestureRecognizerCoordinator NativeGestureCoordinator
        {
            get; set;
        }
        ...
        internal INativeGestureRecognizer NativeGestureRecognizer
        {
            get; set;
        }
